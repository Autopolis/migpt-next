...
最近 12 条消息用于上下文；五分钟没有新问题或退出会话时清空。包含“天气”“闹钟”“空调”“几点”的话语一律交给原生小爱，包括带“怎么”“为什么”的问法；这些话语不请求模型、不暂停原生回答，也不触发本机自动续听。其他常见音乐、音量、家电控制继续交给原生小爱；这是一个保守的关键词分类器，可能漏识别复杂口令，不能视为完整的智能家居控制系统。
